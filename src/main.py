...
def selectParent(population, fitness_values):
...
def crossover(parent1, parent2):
    ...
    # No crossover: return copies of the parents (keep genome length)
...
def geneticAlgorithm():
    ...
    for generation in range(GENERATIONS):
        ...
        for _ in range(POPULATION_SIZE // 2):
            parent1 = selectParent(population, fitness_values)
            parent2 = selectParent(population, fitness_values)
